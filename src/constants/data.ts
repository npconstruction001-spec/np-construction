...
export const PORTFOLIO: Project[] = [
  {
    ...
    fallback: imgLotusConstruction,
    details: "งานออกแบบ ติดตั้ง และปรับปรุงระบบสถาปัตยกรรมภายใน (Interior) งานผนัง ฝ้าเพดาน และงานระบบแสงสว่างประหยัดพลังงานให้สอดคล้องกับมาตรฐานความปลอดภัยอย่างประณีตและปลอดภัยสูงสุด ในระยะการทดสอบระบบ",
    location: "จังหวัดลพบุรี",
    duration: "45 วัน",
    year: "พ.ศ. 2567",
    scope: ["งานบูรกระบวนการสปริงเกอร์ดับเพลิงสากล", "งานเดินท่อและระบบแสงสว่างแบบประหยัดไฟ LED", "งานจัดหาจัดซื้อโปร่งใสงวดหน่วยรัฐ"],
    gallery: [
      imgLotusConstruction,
      imgTescoLotus,
      imgBannerLeft,
  ...
  {
    title: "เทสโก้โลตัส สาขาบางนา",
    category: "งานระบบ Facade",
    image: imgAirAndElec,
